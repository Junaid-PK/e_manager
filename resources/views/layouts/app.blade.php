                    ...
                    <nav class="space-y-1 px-2">
                        @php
                            $navItems = [
                                ...
                                ['route' => 'invoices.retention', 'label' => __('app.retention_page'),    'icon' => 'calendar',                 'permission' => 'invoices.retention'],
                                ...
                                ['route' => 'expenses',         'label' => __('app.expenses'),           'icon' => 'banknotes',                'permission' => 'expenses.view'],
                                ['route' => 'expense-listado-config', 'label' => __('app.expense_listado_config'), 'icon' => 'clipboard-document-list', 'permission' => 'expenses.view'],
                                ['route' => 'companies-clients','label' => __('app.companies_clients'),  'icon' => 'users',                    'permission' => 'companies_clients.view'],
                                ['route' => 'workers',          'label' => __('app.workers'),            'icon' => 'user-group',               'permission' => 'workers.view'],
                                ['route' => 'project-months',   'label' => __('app.project_months'),     'icon' => 'table-cells',              'permission' => 'project_months.view'],
                                ['route' => 'worker-project-entries', 'label' => __('app.worker_project_entries'), 'icon' => 'clipboard-document-check', 'permission' => 'worker_project_entries.view'],
                                ['route' => 'worker-payments',  'label' => __('app.worker_payments'),    'icon' => 'banknotes',                'permission' => 'worker_payments.view'],
                                ['route' => 'project-invoices', 'label' => __('app.project_invoices'),   'icon' => 'document-text',            'permission' => 'project_invoices.view'],
                                ['route' => 'project-expenses', 'label' => __('app.project_expenses'),   'icon' => 'banknotes',                'permission' => 'project_expenses.view'],
                                ['route' => 'worker-monthly-summaries', 'label' => __('app.worker_monthly_summaries'), 'icon' => 'document-chart-bar', 'permission' => 'worker_monthly_summaries.view'],
                                ['route' => 'period-dashboard', 'label' => __('app.period_dashboard'),   'icon' => 'view-columns',             'permission' => 'period_dashboard.view'],
                                ['route' => 'users',            'label' => __('app.users'),              'icon' => 'users',                    'permission' => 'users.view'],
                                ['route' => 'roles',            'label' => __('app.roles_and_permissions'), 'icon' => 'shield-check',         'permission' => 'roles.view'],
                                ['route' => 'settings',         'label' => __('app.settings'),           'icon' => 'cog-6-tooth',              'permission' => 'settings.view'],
                            ];
                        @endphp
